...
new Vue({
    ...
    data:{
        ...
        log_text:{
            attack : "player's attack : ",
            special_attack: "player's special attack : ",
            monster_attack: "monster's attack : ",
            heal_up: "heal up",
    ...
    watch : {
        player_heal: function(value){
            if(value <= 0){
                this.player_heal = 0;
               if(confirm("Oyunu kaybettin, tekrar go?")){
        ...
        monster_heal: function(value){
            if(value <= 0){
                this.monster_heal = 0;
                if(confirm("Oyunu kazandin, tekrar go?")){
                    this.player_heal=100;
                    this.monster_heal=100;
                    this.logs= [];
